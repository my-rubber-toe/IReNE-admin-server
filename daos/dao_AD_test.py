...
# print(ids)
# admin_id = "5e9410a34bba03037cc418d3"
...
#     ids.append(id_string)
# print(ids)
# collab_ID = "5e9410a34bba03037cc418ce"
...
# print("new status: ", current_status.email, current_status.approved)
...
# new_status = Collaborator.objects.get(id= collab_ID)
# print("new status: ", current_status.email, current_status.banned)
...
#     ids.append(id_string)
# print(ids)
# doc_ID = "5e9410a34bba03037cc418ce"
...
# print("new status: ", current_status.title, current_status.published)
